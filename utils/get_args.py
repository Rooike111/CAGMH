...
def get_args():
    ...
    #######################
    parser.add_argument("--query-num", type=int, default=5000)#2000
    ...
    parser.add_argument("--lossseed", type=int, default=0)

    parser.add_argument("--lr", type=float, default=0.001)
    parser.add_argument("--alpha", type=float, default=0.8)
    parser.add_argument("--lr-decay", type=float, default=0.9)
    parser.add_argument("--clip-lr", type=float, default=0.00001)
    parser.add_argument("--weight-decay", type=float, default=1.4)
    parser.add_argument("--warmup-proportion", type=float, default=0.1,
                        help="Proportion of training to perform linear learning rate warmup for. E.g., 0.1 = 10%% of training.")
    parser.add_argument("--balance-weight", type=float, default=0.004)
    parser.add_argument("--lambda1", type=float, default=0.009)
